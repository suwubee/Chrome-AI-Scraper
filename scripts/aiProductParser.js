...
3. 智能数据筛选要求：
商品信息提取规则：
- 查找代码中主标题，通常为H1或者H2标签，通常也是产品名称
- 在产品名称附近或者代码下面，通常会出现类似price，option的标签，即商品的价格和属性，属性通常有size、color等
- 通常在商品信息的框架内会有商品主要信息，即组合而成descriptionHtml，请注意主要信息肯定不是全部页面代码
- 请理解提取商品的内容以及结构，正确提取和商品信息强关联的信息，过滤掉推荐产品，相关产品
